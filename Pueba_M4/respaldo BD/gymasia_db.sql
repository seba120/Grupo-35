...
1	Sebast¡an	Boettiger	55555555	seba@seba.com	5
...
COPY public.pase (id_pase, nombre_pase, detalle_pase, fecha_pase) FROM stdin;
1	matutino	valido de 07:00 a 11:59	2020-10-15
2	break office	valido de 12:00 a 16:59	2020-10-18
3	after office	valido desde 17:00 a 19:59	2020-11-14
4	vespertino	valido desde 20:00 a 23:59	2020-11-30
5	nocturno	valido desde 00:00 a 03:00	2020-12-07
\.
...
3	isot¢nica	powerade 1 l	2000	500
4	barra energ‚tica	squeezy 50g	1000	1000
5	energ‚tica	monster 0 az£car	2500	1000
6	energ‚tica	red bull	2200	800
7	toalla personal	tama¤o 40x60	4000	200
...
1	Mensual	Cliente puede participar de todas las clases e instalaciones del gymAsia durante 30 d¡as desde la contrataci¢n.	30000
2	Trimestral	Cliente puede participar de todas las clases e instalaciones del gymAsia durante 90 d¡as desde la contrataci¢n.	90000
3	Semestral	Cliente puede participar de todas las clases e instalaciones del gymAsia durante 120 d¡as desde la contrataci¢n.	120000
4	Anual	Cliente puede participar de todas las clases e instalaciones del gymAsia durante 1 a¤o desde la contrataci¢n.	150000
5	Estudiante	Plan especial para estudiantes desde los 16 a¤os, donde el cliente puede participar de todas las clases e instalaciones del gymAsia durante 30 d¡as hasta las 16:00 hrs.	20000
\.
...
COPY public.transaccion_pase (id_transaccion, id_pase) FROM stdin;
\.
